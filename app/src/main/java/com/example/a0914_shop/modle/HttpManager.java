...
import com.example.a0914_shop.common.Constants;
import com.example.a0914_shop.utils.DigestUtils;
import com.example.a0914_shop.utils.SpUtils;
...
public class HttpManager {
    ...
    public ApiService getApiService(){
        if (apiService==null){
            apiService = getRetrofit(Constants.Base_MallUrl).create(ApiService.class);
        }
        return apiService;
    }
